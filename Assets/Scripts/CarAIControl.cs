...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        private Movement m_CarController;    // Reference to actual car controller we are controlling
        ...
        private void Awake()
        {
            ...
            m_CarController = GetComponent<Movement>();
        ...
        private void FixedUpdate()
        {
            if (m_Target == null || !m_Driving)
            {
                ...
                m_CarController.Move(0, 0, -1f);
            }
            else
            {
                Vector3 fwd = transform.forward;
                if (m_Rigidbody.velocity.magnitude > m_CarController.maxTorque*0.1f)
                {
                    fwd = m_Rigidbody.velocity;
                }

                float desiredSpeed = m_CarController.maxTorque;
                    ...
                    case BrakeCondition.TargetDirectionDifference:
                        {
                            ...
                            desiredSpeed = Mathf.Lerp(m_CarController.maxTorque, m_CarController.maxTorque*m_CautiousSpeedFactor,
                ...
                float accelBrakeSensitivity = (desiredSpeed < m_CarController.maxTorque)
                                                  ? m_BrakeSensitivity
                                                  : m_AccelSensitivity;

                // decide the actual amount of accel/brake input to achieve desired speed.
                float accel = Mathf.Clamp((desiredSpeed - m_CarController.maxTorque)*accelBrakeSensitivity, -1, 1);
                ...
                float steer = Mathf.Clamp(targetAngle*m_SteerSensitivity, -1, 1)*Mathf.Sign(m_CarController.maxTorque);
